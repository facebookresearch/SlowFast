...
from slowfast.utils.meters_deprecated import TrainMeter, ValMeter
...
def train_epoch(train_loader, model, optimizer, train_meter, cur_epoch, cfg):
    ...
    for cur_iter, (inputs, labels, _) in enumerate(train_loader):
        ...
        # TODO: support arbitrary number of topk_err
        # Compute the errors.
...
def train(cfg):
    ...
    if cfg.TRAIN.AUTO_RESUME and cu.has_checkpoint(cfg.OUTPUT_DIR):
        ...
        checkpoint_epoch = cu.load_checkpoint(
            cfg.TRAIN.CHECKPOINT_FILE_PATH, model, cfg.NUM_GPUS > 1, optimizer
        )
        start_epoch = checkpoint_epoch + 1
    else:
        start_epoch = 0
