...
import slowfast.datasets.fb.everstore_deprecated as everstore
import slowfast.datasets.transform_deprecated as transform
...
# TODO: remove the word multi-clip and replace with multi-view.
...
class Kinetics(torch.utils.data.Dataset):
    ...
    # TODO: change fb to local for oss
    def __init__(self, cfg, mode, num_retries=10):
        ...
        Args:
            ...
            mode (string): Options includes `train`, `val`, or `test` mode.
                ...
                TODO: remove the `everstore` option for open source code
                release.
        """
        ...
        self._video_meta = {}
        self._data_source = cfg.DATA.DATA_SOURCE
        ...
        for _ in range(self._num_retries):
            ...
            try:
                if self._data_source == "local":
                    with open(self._path_to_videos[index], "rb") as f:
                        raw_video = BytesIO(f.read())
                else:
                    raw_video = everstore.fetch_video(
