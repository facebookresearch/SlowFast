...
# We can skip reviewing this diff since it will be moved to fvcore.
# TODO: consolidating transform with D2 and move to fvcore
...
def random_short_side_scale_jitter(images, min_size, max_size):
    ...
    return torch.nn.functional.interpolate(
        images, size=(new_height, new_width), mode="bilinear"
    )
